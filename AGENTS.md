...
Django 6.0 + DRF base template used as the starting point for Linkchar projects. Postgres 16, JWT + allauth (Google OAuth), drf-spectacular, Docker, `just` task runner.
